...
import crypto from 'crypto';               // this is for creating a random token
import nodemailer from 'nodemailer';       // this is for sending email
...
-------------------------------------------- */
export const report_forgotten_password = async (req: Request, res: Response, next: NextFunction)=>{
  try {
...
-------------------------------------------- */
export const reset_old_password_with_new_one = async (req: Request, res: Response, next: NextFunction)=>{
  try {
